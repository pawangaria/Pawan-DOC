...
public class NewArrivals_TC1 extends NewArrivalsSuitesBase{
	...
	String runmodes[]=null;
		...
		public void checkTestSkip()
		{
				...
				//Instead of passing TestCase name,using this "this.getClass().getSimpleName()" to get the name of the class as the name of the class is the TestCase name.
			{
				...
				APP_LOGS.debug("Skipping test case NewArrivals_TC1(NewArrivals Test outer DD  Check) as the runmode is NO");
				throw new SkipException("Skipping this testcase NewArrivals_TC1(NewArrivals Test outer DD  Check) as the runmode is NO for this testcase");
		...
		@Test
		public void NewArrivalsTestLink_DD() throws InterruptedException
		{
		   ...
		   //"****** Starting the Test for NewArrivalsTest_TC1(NewArrivalsTest outer link Check ******* 
						 
			APP_LOGS.debug("****** Starting the Test for NewArrivalsTest_TC1(NewArrivalsTest outer link Check) *******");
			
			String Xpath_Outer =OR.getProperty("NEWARRIVALS_MAIN_LINK_XPATH");
			String Xpath_Block =OR.getProperty("NEWARRIVALS_DROPDOWN_BLOCK_XPATH");
		    ...
		    APP_LOGS.debug("****** Completed the Test for NewArrivalsTest_TC1(NewArrivalsTest outer link Check) *******");
			
			}catch(Throwable t)
			{
				APP_LOGS.debug("******Execution of the NewArrivalsTest_TC1(NewArrivalsTest outer DD  Check) is falied******");
