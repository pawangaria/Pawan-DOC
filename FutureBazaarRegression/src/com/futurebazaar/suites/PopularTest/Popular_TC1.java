...
public class Popular_TC1 extends PopularSuitesBase{
	...
	String runmodes[]=null;
		...
		public void PopularTestLink_DD() throws InterruptedException
		{
		   ...
		   //"****** Starting the Test for PopularTest_TC1(PopularTest outer link Check ******** 
			...
			APP_LOGS.debug("****** Starting the Test for Popular_TC1(PopularTest outer link Check *******");
			
			String Xpath_Outer =OR.getProperty("POPULAR_MAIN_LINK_XPATH");
			String Xpath_Block =OR.getProperty("POPULAR_DROPDOWN_BLOCK_XPATH");
			...
			APP_LOGS.debug("****** Completed the Test for Popular_TC1(PopularTest outer link Check *******");
