...
public class HomePage_TC4 extends HomePageSuitebase{
	...
	String runmodes[]=null;
		...
		public void newArrivals() throws InterruptedException
		{
		    ...
		    */
			...
			//this method is used to verify the HOme page option 
				...
				WebElement topsellers = driver.findElement(By.xpath(".//*[@id='home']/div[2]/div[2]/div[10]"));
	    ...
	    {
	         System.out.println("For the New Arrivals Product box no."+box);
