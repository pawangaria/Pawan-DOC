...
public class HomePage_TC3 extends HomePageSuitebase{
	...
	String runmodes[]=null;
		...
		public void checkTestSkip()
		{
			...
			{   
				...
				APP_LOGS.debug("skipping test HomePage_TC3 as the runmode is NO");
		...
		@Test(dataProvider="getTestData")
		public void topSellers() throws InterruptedException
		{
			try{
			count++;
		    ...
		    */
			...
			//this method is used to verify the HOme page option 
				...
				//Checking the Top Sellers header.
				WebElement topsellers = driver.findElement(By.xpath(".//*[@id='home']/div[2]/div[2]/div[7]"));
				
				String Top_Sellers_String= topsellers.findElement(By.tagName("h1")).getText();
			     System.out.println(Top_Sellers_String);
				Assert.assertEquals(Top_Sellers_String,"TOP SELLERS");
				
				checkboxes(".//*[@id='home']/div[2]/div[2]/div[8]/ul/li[2]/div",".//*[@id='home']/div[2]/div[2]/div[8]/ul/li[2]/div/h3",".//*[@id='home']/div[2]/div[2]/div[8]/ul/li[2]/div/div[3]");
				checkboxes(".//*[@id='home']/div[2]/div[2]/div[8]/ul/li[3]/div",".//*[@id='home']/div[2]/div[2]/div[8]/ul/li[3]/div/h3",".//*[@id='home']/div[2]/div[2]/div[8]/ul/li[3]/div/div[3]");
				checkboxes(".//*[@id='home']/div[2]/div[2]/div[8]/ul/li[4]/div",".//*[@id='home']/div[2]/div[2]/div[8]/ul/li[4]/div/h3",".//*[@id='home']/div[2]/div[2]/div[8]/ul/li[4]/div/div[3]");
				//***********************************************
			}catch(Throwable t)
			{
				APP_LOGS.debug("*******Execution for the HomePage_TC3 is falied*****");
				t.getMessage();
		...
		public static void checkboxes(String boxxpath,String productlink,String pricesAndbuynow) throws InterruptedException
	    {
	         System.out.println("For the ToDays Deals Product box no."+box);
		    ...
		    Assert.assertTrue(num>0,"Some value is missing from the Save Blue Tag on the Product");
		     ...
		     // System.out.println(link1.isDisplayed());
			  ...
			  //time
		      System.out.println("to top sellers icon");
		   			 Thread.sleep(5000);
				
				WebElement menu = pp.findElement(By.className("timer_outer"));
				...
				builder.moveToElement(menu).build().perform();
			      ...
			      WebElement tu = menu.findElement(By.className("timer_comment"));
					String hotsellerTag = tu.findElement(By.tagName("strong")).getText();
					
				System.out.println(menu.findElement(By.className("timer_comment")).getText());	
				    
				  System.out.println(hotsellerTag);
