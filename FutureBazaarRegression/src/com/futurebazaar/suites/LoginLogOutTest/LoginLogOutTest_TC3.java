...
public class LoginLogOutTest_TC3 extends LoginLogOutSuiteBase{
	...
	String runmodes[]=null;
		...
		public void checkTestSkip()
		{
				...
				//Instead of passing TestCase name,using this "this.getClass().getSimpleName()" to get the name of the class as the name of the class is the TestCase name.
			{
				...
				APP_LOGS.debug("Skipping test case LoginLogOutTest_TC3(Login/Logout from Login Page) as the runmode is NO");
				throw new SkipException("Skipping this testcase LoginLogOutTest_TC3(Login/Logout from Login Page) as the runmode is NO for this testcase");
		...
		@Test
		public void LogInLogOutPageCheck() throws InterruptedException
		{
			...
			APP_LOGS.debug("****** Starting the Test for LoginLogOutTest_TC3(Login/Logout from Login Page *******");
			...
			//User Log in from the LoginUser Method.
			  ...
			  APP_LOGS.debug("****** Completed the Test for LoginLogOutTest_TC3(Login/Logout from Login Page ) *******");
			
			}catch(Throwable t)
			{
				APP_LOGS.debug("******Execution of the LoginLogOutTest_TC3(Login/Logout from Login Page) is falied******");
