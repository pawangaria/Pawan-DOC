...
public class GiftsTest_TC2 extends GiftsSuiteBase{
	...
	String runmodes[]=null;
		...
		public void checkTestSkip()
		{
				...
				//Instead of passing TestCase name,using this "this.getClass().getSimpleName()" to get the name of the class as the name of the class is the TestCase name.
			{
				...
				APP_LOGS.debug("Skipping test case GiftsTest_TC2(GiftsTest Inner DD  Check) as the runmode is NO");
				throw new SkipException("Skipping this testcase GiftsTest_TC2(GiftsTest Inner DD  Check) as the runmode is NO for this testcase");
		...
		@Test
		public void GiftsTestInnerLink_DD() throws InterruptedException
		{
			...
			//"****** Starting the Test for GiftsTest_TC2(GiftsTest Inner link Check ******* 
			 
			APP_LOGS.debug("****** Starting the Test for GiftsTest_TC2(GiftsTest Inner link Check ******");
			String Xpath_Outer =null;
		     //int link_number= nextIntInRange(1,12,rnd);
				 WebElement kk = driver.findElement(By.xpath(OR.getProperty("Gifts_DROPDOWN_BLOCK_XPATH")));
		       ...
		       // System.out.println("link_number:"+i);
		        String  Gifts_InnerLink_Xpath="//div[@id='menu']/ul/li[4]/div/div/ul/li["+i+"]/a"; 
		        Xpath_Outer=OR.getProperty("Gifts_MAIN_LINK_XPATH");
		        LowerMenuInOutLink.LowerMenu_InnerLink(Xpath_Outer,Gifts_InnerLink_Xpath);
		    	APP_LOGS.debug("****** Completed the Test for GiftsTest_TC2(GiftsTest Inner link Check ******");
				
			}
			}catch(Throwable t)
			{
				APP_LOGS.debug("******Execution of the GiftsTest_TC2(GiftsTest Inner DD  Check) is falied******");
