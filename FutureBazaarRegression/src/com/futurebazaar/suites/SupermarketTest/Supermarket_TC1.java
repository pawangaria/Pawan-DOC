...
public class Supermarket_TC1 extends SupermarketSuitesBase{
	...
	String runmodes[]=null;
		...
		public void checkTestSkip()
		{
				...
				//Instead of passing TestCase name,using this "this.getClass().getSimpleName()" to get the name of the class as the name of the class is the TestCase name.
			{
				...
				APP_LOGS.debug("Skipping test case Supermarket_TC1(Supermarket_TC1 Drop down Check) as the runmode is NO");
				throw new SkipException("Skipping this testcase Supermarket_TC1(Supermarket_TC1 Drop down Check) as the runmode is NO for this testcase");
		...
		@Test
		public void Supermarket_DDCheck() throws InterruptedException
		{
            ...
            APP_LOGS.debug("****** Starting the Test for Supermarket_TC1(Supermarket outer link Check *******  ");
			
			String Xpath_Outer =OR.getProperty("Supermarket_MAIN_LINK_XPATH");
			String Xpath_Block =OR.getProperty("Supermarket_DROPDOWN_BLOCK_XPATH");
			...
			{
				APP_LOGS.debug("******Execution of the Supermarket_TC1(Supermarket Drop down Check) is falied******");
