...
import com.futurebazaar.testing.util.TestUtil;
 ...
 public class AddToCart_TC3  extends AddToCartSuitebase{
	...
	String runmodes[]=null;
		...
		public void checkTestSkip()
		{
			...
			{
				APP_LOGS.debug("skipping test AddToCart_TC3(itemCartCleanUP) as the runmode is NO");
				throw new SkipException("Skipping this testcase AddToCart_TC3(itemCartCleanUP) as the runmode is NO for this Testcase");
		...
		@Test
		public void itemCartCleanUP() throws InterruptedException
		{
			try{
			count++;
			...
			*/
		    ...
		    //adding the Product to the cart to remove the Item.
		    ...
		    APP_LOGS.debug("Cleaning items from the cart with out user log in");
		      ...
		      Itemcleanup.itemCleanup();
			    ...
			    APP_LOGS.debug("*****AddToCart_TC3 (Item Cart CleanUP ) test completed ******* ");
	        
		    	      	
			//***********************************************
			}catch(Throwable t)
			{
				APP_LOGS.debug("####### Execution for the AddToCart_TC3 (Item Cart CleanUP ) is falied ######");
