...
public class SendCODordersMail
{
	public  static void Mailsend(String Orderid,String url){

    String to[] = {"rakesh.vichare@futuregroup.in","manuel.d'souza@futuregroup.in"};
    //adding CC
     String cc[] = {"fb-qa@futuregroup.in","hemanth.goteti@futuregroup.in","shabbir.kawari@futuregroup.in","sourabh.gaikwad@futuregroup.in"};
  ...
  //     message.addRecipient(Message.RecipientType.BCC,new InternetAddress(bcc));
        ...
        message.setSubject("COD Order cancellation for Build Push Sanity");
        ...
        messageBodyPart.setText( "Cash on Delivery Order has been placed on "+url+" for the Build Push Sanity Test, So please cancel the order No. "+Orderid+".");
